...
class PowerNodeTest extends BinaryNodeTest {

  @Test
  void evaluate() {
    Node node = new PowerNode(new ConstantNode(3), new ConstantNode(2));
  ...
  void evaluateOutOfRange() {
    Node node = new PowerNode(new ConstantNode(Double.MAX_VALUE), new ConstantNode(10));
