...
class DivisionNodeTest extends BinaryNodeTest {

  @Test
  void evaluate() {
    Node node = new DivisionNode(new ConstantNode(1), new ConstantNode(2));
  ...
  void evaluateOutOfRange() {
    Node node = new DivisionNode(new ConstantNode(1), new ConstantNode(0));
