...
class MinusNodeTest extends BinaryNodeTest {

  @Test
  void evaluate() {
    Node node = new MinusNode(new ConstantNode(3), new ConstantNode(2));
  ...
  void evaluateOutOfRange() {
    Node node = new MinusNode(new ConstantNode(-Double.MAX_VALUE), new ConstantNode(Double.MAX_VALUE));
