...
class ArcTanNodeTest extends AbstractTrigonometricNodeTest {

  @Test
  void evaluate() {
    Node node = new ArcTanNode(new ConstantNode(1));
    double result = node.evaluate(null);
    assertEquals(StrictMath.PI / 4, result, 1e-9);
  }
